 ...
 ?>
	<fieldset class="field_home">
 		<h1>Just-in-time: otimize sua produção e corte custos</h1>
			...
			<p>O Just-in-time, ou JIT, como o sistema é conhecido, assim como o conceito de Qualidade Total, é uma forma de gerir a produção focada em resultados e melhorias de processos. Trata-se de um método de gestão e controle de produção cujo objetivo é minimizar erros e assegurar as qualidade do produto final durante o processo de produção. Apostando num modelo Just-in-time, a empresa ganha em velocidade, qualidade e preço de seus produtos.

			<h3>Afinal, o que é o modelo just-in-time?</h3>

			<p>O modelo de gestão JIT propõe que a produção seja feita de acordo com a demanda, então, a empresa vai produzir naquele momento somente os produtos necessários, nas quantidades necessárias. E esse processo se repete em cada etapa da produção. Com isso, em primeiro lugar, na medida em que se produz apenas aquilo que é demandado, ganha-se diminuindo a necessidade de espaço para estoque de insumos e mercadorias. Em seguida, ganha-se com economia em transportadoras e sistemas de distribuição. E em terceiro, diminui-se o desperdício de insumos. O nome, “just-in-time” vem da característica do modelo: produzir e entregar os produtos a tempo (ou, em inglês, just in time) de serem vendidos.  Materiais sendo transformados a tempo se se tornarem peças e peças sendo montadas a tempo de se tornarem produtos finais.</p>

			<h3>E tudo começou lá na terra do sol nascente…</h3>

			<p>O just-in-time, assim como o Kanban,  foi desenvolvido e aplicado pela primeira vez nos anos 50, mais especificamente na fábrica da Toyota, no Japão. Os japoneses são notoriamente conhecidos pelos seus métodos de organização, o 5S e o <a href="https://endeavor.org.br/estrategia-e-gestao/poka-yoke/" target="_blank">Poka Yoke são outros exemplos de ferramentas muito úteis	</a> desenvolvidas por eles, e o JIT não deixa a desejar em nenhum aspecto.
			...
			<img src="../img/gestao-da-cadeia-logistica-wp-1038x576-1.jpg">
			</figure>
			...
			E bota resultado nisso: nessa corrida por cortar custos e melhorar a produção, a Toyota, que demorava 1 hora para preparar uma prensa de 800 toneladas que era usada para moldar capôs e pára-choques, conseguiu reduzir esse tempo para apenas 12 minutos. Ainda hoje a empresa aposta no modelo. <a href="https://www.toyota-global.com/company/vision_philosophy/toyota_production_system/just-in-time.html" target="_blank">Aqui você vê um exemplo e como eles organizam a produção.</a></p>

			<h3>Muito mais do que um modelo de gestão de produção</h3>

			<p>O modelo deu tão certo, que passou a ser considerado muito mais do que uma técnica de gestão de produção, ampliando-se para diversas áreas da empresa, como a gestão de materiais, qualidade, organização física dos meios produtivos, engenharia de produto, organização do trabalho e gestão de recursos humanos.
			...
			Hoje muitas empresas aplicam a metodologia, como Votorantim, Embraer, Avon, Unilever, Fiat, etc.</p>