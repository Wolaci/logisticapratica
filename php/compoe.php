           ...
           <div>
              <div class="col-lg-12 col-md-6 col-sm-12 col-xs-12">    
                ...
                <table border="1" cellpadding="5" cellspacing="0">
                    ...
                    <?php
                    $_comp=$conn->prepare('SELECT produto_pdo.nome,compoe.quantidade from produto_pdo join compoe
                        on produto_pdo.id = compoe.id_produto or produto_pdo.id = compoe.id_componente WHERE fk_user=?');  
                        ?>
                    </div>
                    <br>
